                            ...
                            <div className="col-md-3 col-sm-3 col-xs-12 user-profil-part pull-left">
                                <div className="row ">
                                    <div className="col-md-12 col-md-12-sm-12 col-xs-12 user-image text-center">
                                        <img src={`https://regtech-meduim.herokuapp.com/${customer.thumbnailPath}`} alt="Profile Pic" className="rounded-circle" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container mt-2">
                            ...
                            <div className="tab-content">
                                ...
                                <div id="files" className={'container tab-pane'+ (currenTab.files ? ' active':'')}><br />
                                    <div className="pb-4">
                                        <a href={`https://regtech-meduim.herokuapp.com/${customer.documentPath}`} target="_blank"  rel="noopener noreferrer">
                                            <FileEarmarkText /> <strong>Uploaded document</strong>
                                        </a>
                                    </div>
                                    <div>
                                        <a href={`https://regtech-meduim.herokuapp.com/${customer.videoPath}`} target="_blank" rel="noopener noreferrer">
